...
?>
<div class="container-fluid row" style="margin-bottom: 200px;">
<form class="col-4 p-3" action="../../controllers/controlnmuebles.php" method="post">
    <h3 class="text-center">Tipos de inmuebles</h3>
  <div class="mb-3">
